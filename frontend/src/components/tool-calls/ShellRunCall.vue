      ...
      <t-collapse-panel :value="1" destroy-on-close>
        <template #header>
          <div>
            ...
            &nbsp;
            <code v-if="args.command">{{ args.command }}</code>
            <code v-else-if="args.session_id">({{ args.session_id }})</code>
            &nbsp;
            <t-tag v-if="args.background" theme="primary" variant="light"
              >Background</t-tag
            >
            &nbsp;
            <t-tag
        ...
        <div class="content-area">
          <t-space direction="vertical">
            ...
            <div v-if="args.background !== undefined">
              Background: <code>{{ args.background }}</code>
            </div>
